...
func TestParseArgs(t *testing.T) {
	cases := []struct {
		...
		// The --attn hook flags were removed when attention detection moved fully to
		// pane text; --attn is now just an unknown flag.
		{"attn rejected", []string{"--attn"}, ParsedArgs{}, true},
